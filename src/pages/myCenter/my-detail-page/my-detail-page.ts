...
export class MyDetailPagePage {
	...
	hospDep:any = [];
	imgbase64:string = "";
	constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController,public courseService:CourseService,public commonService:CommonService,private domSanitizer: DomSanitizer,
		public toastCtrl: ToastController,public commonCheck: CommonCheck,public http:Http,public localstorage:Localstorage) {
		this.getStatecode();
		this.getHospital();
		this.getUserByRUid();
	}
